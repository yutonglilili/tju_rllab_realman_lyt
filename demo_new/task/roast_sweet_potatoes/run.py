...
from demo_new.skills.air_fryer_skill.air_fryer import open_air_fryer, close_air_fryer, rotate_air_fryer_timer_button
...
def main():
    ...
    task_list = [
        {
            "pick": "banana", "place": "open air fryer drawer",
        },
        {
            "pick": "oringe", "place": "open air fryer drawer",
        }
    ]
